...
- **ChatInput Component Rollback**: Restored ChatInput component to yesterday's white 8% opacity focus styling with transparent background and white gradient borders
