...
export function AppHeader({ 
  ...
  useEffect(() => {
    console.log('AppHeader: Setting up scroll listener');
    ...
    console.log('AppHeader: Initial scroll position:', window.scrollY);
    handleScroll();
    
    // Add scroll listener to window only
    window.addEventListener('scroll', handleScroll, { passive: true });
    
    return () => {
      console.log('AppHeader: Cleaning up scroll listener');
