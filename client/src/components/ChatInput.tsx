      ...
      <div
        style={{
          ...
          backgroundImage: isFocused
            ...
            : "linear-gradient(#1C1C1C, #1C1C1C), linear-gradient(315deg, rgba(59, 130, 246, 0.5), rgba(139, 92, 246, 0.4), rgba(34, 211, 238, 0.3))",
          backgroundOrigin: "border-box",
          backgroundClip: "padding-box, border-box",
          overflow: "hidden",
          animation: !isFocused ? "bg-hue-idle 1s linear infinite" : "none",
        }}
      >
        {isFocused && (
