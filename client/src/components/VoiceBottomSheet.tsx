...
import WineCircleImage from './WineCircleImage';
  ...
  const bottomSheetContent = (
    <>
      ...
      >
        ...
        {/* Wine glass visualization - exploded/larger version */}
        <div 
          style={{ 
            width: '280px', // Much larger for visual impact
            height: '280px',
            marginBottom: '40px',
            marginTop: '10px',
            borderRadius: '50%',
        ...
        >
          {/* Wine circle image component with embedded image */}
          <WineCircleImage 
            size={280} 
