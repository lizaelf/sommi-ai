            ...
            >
              ...
              >
                ...
                <div
                  onClick={() => {
                    setExpandedItem(
                      expandedItem === "collection" ? null : "collection",
                    );
                  }}
                  style={{
                    backgroundColor: "#191919",
                    ...
                    >
                      <div style={{ paddingLeft: "20px", margin: "10px 0" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
                          <span style={{ fontSize: "16px" }}>📖</span>
                          <span>Explore similar wines in your collection</span>
                        </div>
                        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
                          <span style={{ fontSize: "16px" }}>🏆</span>
                          <span>View highly rated wines</span>
                        </div>
                        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
                          <span style={{ fontSize: "16px" }}>🎯</span>
                ...
                {/* Wine Education - Expandable */}
                <div
                  onClick={() => {
                    setExpandedItem(
                      expandedItem === "education" ? null : "education",
                    );
                  }}
                  style={{
                    backgroundColor: "#191919",
                  ...
                  {expandedItem === "education" && (
                    ...
                    >
                      <div style={{ paddingLeft: "20px", margin: "10px 0" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
                          <span style={{ fontSize: "16px" }}>📚</span>
                          <span>Learn about wine regions and terroir</span>
                        </div>
                        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
                          <span style={{ fontSize: "16px" }}>🍇</span>
                          <span>Understand grape varieties and characteristics</span>
                        </div>
                        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
                          <span style={{ fontSize: "16px" }}>🥂</span>
                          <span>Master wine tasting techniques</span>
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  {expandedItem === "services" && (
                    ...
                    >
                      <div style={{ paddingLeft: "20px", margin: "10px 0" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
                          <span style={{ fontSize: "16px" }}>📱</span>
                          <span>Set up restock notifications</span>
                        </div>
                        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
                          <span style={{ fontSize: "16px" }}>🚚</span>
                          <span>Schedule regular deliveries</span>
                        </div>
                        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
                          <span style={{ fontSize: "16px" }}>👨‍🍳</span>
                          <span>Connect with sommelier for advice</span>
                        </div>
                      </div>
                    </div>
                  )}
