            ...
            <div className="w-full bg-black flex flex-col items-center justify-center py-8 relative">
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{ width: '80px', fontSize: '16px' }}>Light</div>
                  <div style={{ 
                    flex: '1', 
                    height: '4px', 
                  ...
                  <div style={{ width: '80px', fontSize: '16px', textAlign: 'right' }}>Bold</div>
                </div>
                ...
                <div style={{
                  ...
                  <div style={{ width: '80px', fontSize: '16px' }}>Smooth</div>
                  <div style={{ 
                    flex: '1', 
                    height: '4px', 
                    backgroundColor: 'rgba(255, 255, 255, 0.2)',
                  ...
                  <div style={{ width: '80px', fontSize: '16px', textAlign: 'right' }}>Tannic</div>
                </div>
                ...
                <div style={{
                  ...
                  <div style={{ width: '80px', fontSize: '16px' }}>Dry</div>
                  <div style={{ 
                    flex: '1', 
                    height: '4px', 
                    backgroundColor: 'rgba(255, 255, 255, 0.2)',
                  ...
                  <div style={{ width: '80px', fontSize: '16px', textAlign: 'right' }}>Sweet</div>
                </div>
                ...
                <div style={{
                  ...
                  <div style={{ width: '80px', fontSize: '16px' }}>Soft</div>
                  <div style={{ 
                    flex: '1', 
                    height: '4px', 
                    backgroundColor: 'rgba(255, 255, 255, 0.2)',
