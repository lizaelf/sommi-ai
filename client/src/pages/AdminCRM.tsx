        ...
        <div className="flex items-center justify-between p-4">
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              style={{
                background: isEditMode ? "rgba(34, 197, 94, 0.2)" : "rgba(255, 255, 255, 0.1)",
                border: isEditMode ? "1px solid rgba(34, 197, 94, 0.3)" : "1px solid rgba(255, 255, 255, 0.2)",
                borderRadius: "6px",
                padding: "8px",
                cursor: "pointer",
                display: "flex",
