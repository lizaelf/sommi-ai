        ...
        {activeTab === 'profile' && (
          <div className='space-y-6'>
            <>
              ...
              <FormInput label='URL key' type='text' value={tenant.profile.tenantName || ''} onChange={(value: string) => handleProfileChange('tenantName', value)} placeholder='example-tenant' required error={tenant.profile.tenantName && !validateTenantName(tenant.profile.tenantName) ? 'Only a-z, A-Z, 0-9, -, _ allowed' : undefined} />
