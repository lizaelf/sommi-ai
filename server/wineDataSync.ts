 ...
 */
export function getDevelopmentWineData(): Wine[] {
  ...
  return [
    ...
    },
    {
      ...
      year: 2021,
      bottles: 2,
      image: '/wines/wine-2-monte-bello-cabernet-sauvignon.png',
...
export function compareWineData(): {
  ...
  const deployedData = getDevelopmentWineData()
 ...
 */
export function syncToDeployed(wineData: Wine[]): { success: boolean; message: string } {
  try {
