...
import { chatCompletionRequestSchema, type ChatCompletionRequest, insertUsedSuggestionPillSchema } from "../shared/schema.js";
import suggestionPillsData from "../shared/suggestionPills.json" assert { type: "json" };
import { z } from "zod";
